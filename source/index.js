...
async function main() {
   ...
   let location = await fetch(`//https://flamboyant-rosalind-326379.netlify.app/https://api.weatherapi.com/v1/forecast.json?key=08d6846f461f4edaa9a91251212101&q=59.9386,30.3141&days=3`)
